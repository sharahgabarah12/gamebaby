...
var astoridImg,astoridCGImg,gameOverImg;
...
function preload(){
  ...
  rocketImg1 = loadImage("rocket_ship.webp");

  astoridImg = loadImage("astorid.png");
  gameOverImg = loadImage("game_over.jpeg");
}
...
function astorid(){
        ...
        astoridCG.addImage(astoridCGImg);
